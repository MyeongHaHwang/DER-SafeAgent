...
APACHE = "Apache-2.0 (repository license)"
...
CURATED = [
    ...
    ("code/configs/ijcip_final_v3/evidence_gate_v3_frozen.json",
     ...
     "Sec. 5 (RQ2), Table 6", APACHE, "released"),
    ("code/configs/ijcip_final_v3/holdout_v3_manifest.csv",
     ...
     "Sec. 5 (RQ3), Tables 8-9, Fig. 4", APACHE, "released"),
    ("code/configs/ijcip_final_v3/holdout_v3_freeze.json",
     ...
     "code/evaluation/final_safeagent_v3/gen_holdout_v3.py",
     "-", "holdout", "-", "Sec. 5 (RQ3)", APACHE, "released"),
    ...
    ("code/configs/ijcip_final_safeagent_20260810/opendss_llm_subset.csv",
     ...
     "Sec. 5 (RQ3), OpenDSS check", APACHE, "released"),
    ("code/configs/ijcip_revision_r1r2_20260805/scenario_manifest.csv",
     ...
     "Sec. 5 (frozen assets); Supplement S4", APACHE, "released"),
    ...
    ("code/results/ijcip_final_v3/holdout_e2e/holdout_e2e_raw.csv",
     ...
     "Tables 8-9, Fig. 4", APACHE, "released"),
    ("code/results/ijcip_final_v3/adversarial/adversarial_raw_qwen.csv",
     ...
     "adversarial-test", "0", "Table 4, Fig. 2", APACHE, "released"),
    ("code/results/ijcip_final_v3/adversarial/adversarial_raw_llama.csv",
     ...
     "evidence_gate_v3_frozen.json; suite seed 0, 5/family",
     "adversarial-test", "0", "Table 5", APACHE, "released"),
    ...
    ("code/results/ijcip_final_v3/eh_robustness/eh_robustness.csv",
     ...
     "holdout", "-", "Table 10", APACHE, "released"),
    ("code/results/ijcip_final_v3/statistics/F1_physical.csv",
     "Primary paired configuration-level statistics (ENS/curtailment vs D0), "
     "Holm-adjusted; resampling draws shared across contrasts (common random "
     "numbers, seed 20260811; protocol amended 2026-08-29 so identical "
     "paired vectors receive identical CIs)",
     "paired sign-flip permutation + bootstrap; RNG seed 20260811",
     "code/evaluation/final_safeagent_v3/run_stats_v3.py",
     "-", "holdout", "20260811", "Table 9", APACHE, "released"),
    ("code/configs/action_policy.yaml",
     "Machine-readable export of the shield's class-aware action policy "
     "(registry, irreversible set, removals, fallback order, thresholds); "
     "generated from code/Multi_AI_Agent/safety_projection.py",
     "runtime constants (single source of truth)",
     "scripts/export_action_policy.py",
     "-", "-", "-", "Sec. 4 (Table action-policy)", APACHE, "released"),
    ("code/results/ijcip_final_revision/e7_trustworthiness/explanation_groundedness.csv",
     "Automated explanation-groundedness audit (template rate, unsupported "
     "claims) behind the 70-73% / 23-30% figures in the discussion",
     "raw model outputs of the archived strict-serving eval runs",
     "code/evaluation/final_revision/run_e7_groundedness.py",
     "-", "eval corpus (146 prompts, K=1; 48, K=3)", "-",
     "Sec. 6 (groundedness audit)", APACHE, "released"),
    ("code/results/ijcip_final_v3/statistics/F2_adversarial.csv",
     ...
     "code/evaluation/final_safeagent_v3/run_stats_v3.py",
     "-", "adversarial-test", "20260811", "Sec. 5 (RQ1)", APACHE, "released"),
    ("code/results/ijcip_final_v3/statistics/F3_gate.csv",
     ...
     "code/evaluation/final_safeagent_v3/run_stats_v3.py",
     "-", "holdout", "20260811", "Sec. 5 (RQ2)", APACHE, "released"),
    ...
    ("code/results/ijcip_final_v3/p0_forensics/p0a_result.json",
     ...
     "-", "holdout", "-", "Table 8 caption", APACHE, "released"),
    ...
    ("code/results/ijcip_final/gate_auth/gate_auth_summary.csv",
     ...
     "-", "-", "2101,2102,2103", "Table 7", APACHE, "released"),
    ...
    ("code/results/ijcip_final/opendss_check/opendss_check_summary.csv",
     ...
     "Sec. 5 (RQ3 physical-fidelity check)", APACHE, "released"),
    ...
    ("code/results/ijcip_final_revision/e6_adversarial/e6_raw.csv",
     ...
     "-", "adversarial-test", "-", "Sec. 5 (RQ1)", APACHE, "released"),
    ("code/results/ijcip_final_safeagent_20260810/p1c_ablation/p1c_by_arm_qwen.csv",
     ...
     "-", "adversarial-test", "-", "claim-consistency tests", APACHE, "released"),
    ("code/results/ijcip_final_safeagent_20260810/p0b_gate/p0b_summary.csv",
     ...
     "-", "test", "-", "claim-consistency tests", APACHE, "released"),
    ...
    ("code/finetuning_dataset/revision_eval/eval_corpus.jsonl",
     ...
     "-", "eval", "-", "Supplement S5; Table 11 provenance", CC0, "released"),
    ...
    for p in sorted((ROOT / "artifacts/reference").rglob("*")):
        if p.is_file():
            ...
            arts.append({
                ...
                "sha256": sha256(p),
                "paper_reference": "Tables 2-11 / Figures 2-4",
                "license": APACHE, "redistribution_status": "released",
            })
